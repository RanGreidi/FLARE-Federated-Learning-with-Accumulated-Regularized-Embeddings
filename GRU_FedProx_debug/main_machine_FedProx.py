...
experiments = {              
              'ROUNDS':               [3001,1001,1001,1001,1001,1001,1001,1001,201],
              'R' :                   [0.001,0.001,0.001,0.001,0.0001,0.0001,0.0001,0.0001,0.0001],
              'E':                    [1,1,11,32,1,4,8,16,1],
              'TAU':                  [0.001,0.1,0.001,0.5,0.5,0.5,0.5,0.5,0.5],                  
              'c':                    [1.00,1.01,1.01,1.05,1.05,1.005,1.005,1.005,0],
...
for experiment in range(num_of_experiments):
    ...
    experiment_name = '{}R_{}E_{}TAU_{}CLIENTS_{}ROUNDS_{}Decay_{}t_{}p_FedProx'.format(R,E,TAU,NUM_CLIENTS,ROUNDS,c,t,config.p)
    ...
    for round in range(ROUNDS):
      ...
      clients_R_fourth_algo = [R_FFL for i in range(NUM_CLIENTS)]
      cleints_E_fourth_algo = [E_FFL for i in range(NUM_CLIENTS)]   
      #FedAvg
