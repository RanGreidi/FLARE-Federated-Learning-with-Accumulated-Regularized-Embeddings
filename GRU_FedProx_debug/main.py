...
experiments = {              
              'ROUNDS':               [401,401,401,301,101,101,101,1001,201],
              'R' :                   [70,0.001,0.001,0.001,0.0001,0.0001,0.0001,0.0001,0.0001],
              'E':                    [1,1,1,1,1,4,8,16,1],
              'TAU':                  [0.0001,0.05,0.05,0.05,0.5,0.5,0.5,0.5,0.5],                  
              'c':                    [1.01,1.001,1.01,1.01,1.01,1.01,1.005,1.005,0],
...
for experiment in range(num_of_experiments):
    ...
    experiment_name = '{}R_{}E_{}TAU_{}CLIENTS_{}ROUNDS_{}Decay_{}t_{}p_grid'.format(R,E,TAU,NUM_CLIENTS,ROUNDS,c,t,config.p)
