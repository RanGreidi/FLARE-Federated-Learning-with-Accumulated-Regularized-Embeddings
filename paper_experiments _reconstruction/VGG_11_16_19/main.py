...
experiments = {              
              'ROUNDS':               [10001,1001,1001,1001,51,51,1001,1001,201],
...
for experiment in range(num_of_experiments):
    ...
    experiment_name = '{}R_{}E_{}TAU_{}CLIENTS_{}ROUNDS_{}Decay_{}t_{}p_vgg19'.format(R,E,TAU,NUM_CLIENTS,ROUNDS,c,t,config.p)
