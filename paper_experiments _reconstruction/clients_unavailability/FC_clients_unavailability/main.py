...
for i,experiment in enumerate(range(num_of_experiments)):
    ...
    number_of_working_clinets = 7-i*2
    experiment_name = '{}R_{}E_{}TAU_{}CLIENTS_{}ROUNDS_{}Decay_{}t_{}p_working_clinets{}'.format(R,E,TAU,NUM_CLIENTS,ROUNDS,c,t,config.p,number_of_working_clinets)
